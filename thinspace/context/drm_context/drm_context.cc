...
void DRMContext::SwapBuffers(void) {
...
void DRMContext::Init(void) {
	...
	*/
	...
	connector = FindConnector (resources);
	...
	*/
	...
	encoder = FindEncoder (resources, connector);
	...
	*/
	...
	config_index = MatchConfigToVisual(
